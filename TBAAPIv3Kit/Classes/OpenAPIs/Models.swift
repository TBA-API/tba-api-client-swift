...
class Decoders {
    ...
    static private func initialize() {
        dispatch_once(&once) {
            ...
            Decoders.addDecoder(clazz: DistrictRankingEventPoints.self) { (source: AnyObject) -> DistrictRankingEventPoints in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = DistrictRankingEventPoints(districtCmp: Decoders.decode(clazz: Bool.self, source: sourceDictionary["district_cmp"]!), total: Decoders.decode(clazz: Int32.self, source: sourceDictionary["total"]!), alliancePoints: Decoders.decode(clazz: Int32.self, source: sourceDictionary["alliance_points"]!), elimPoints: Decoders.decode(clazz: Int32.self, source: sourceDictionary["elim_points"]!), awardPoints: Decoders.decode(clazz: Int32.self, source: sourceDictionary["award_points"]!), eventKey: Decoders.decode(clazz: String.self, source: sourceDictionary["event_key"]!), qualPoints: Decoders.decode(clazz: Int32.self, source: sourceDictionary["qual_points"]!))
                return instance
            }
            ...
            Decoders.addDecoder(clazz: EventDistrictPointsPoints.self) { (source: AnyObject) -> EventDistrictPointsPoints in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = EventDistrictPointsPoints(total: Decoders.decode(clazz: Int32.self, source: sourceDictionary["total"]!), alliancePoints: Decoders.decode(clazz: Int32.self, source: sourceDictionary["alliance_points"]!), elimPoints: Decoders.decode(clazz: Int32.self, source: sourceDictionary["elim_points"]!), awardPoints: Decoders.decode(clazz: Int32.self, source: sourceDictionary["award_points"]!), qualPoints: Decoders.decode(clazz: Int32.self, source: sourceDictionary["qual_points"]!))
                return instance
            }
            ...
            Decoders.addDecoder(clazz: EventRankingExtraStatsInfo.self) { (source: AnyObject) -> EventRankingExtraStatsInfo in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = EventRankingExtraStatsInfo(precision: Decoders.decode(clazz: Double.self, source: sourceDictionary["precision"]!), name: Decoders.decode(clazz: String.self, source: sourceDictionary["name"]!))
                return instance
            }
            ...
            Decoders.addDecoder(clazz: EventRankingRankings.self) { (source: AnyObject) -> EventRankingRankings in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = EventRankingRankings(matchesPlayed: Decoders.decode(clazz: Int32.self, source: sourceDictionary["matches_played"]!), record: Decoders.decode(clazz: WLTRecord.self, source: sourceDictionary["record"]!), rank: Decoders.decode(clazz: Int32.self, source: sourceDictionary["rank"]!), dq: Decoders.decode(clazz: Int32.self, source: sourceDictionary["dq"]!), teamKey: Decoders.decode(clazz: String.self, source: sourceDictionary["team_key"]!))
            ...
            Decoders.addDecoder(clazz: EventRankingSortOrderInfo.self) { (source: AnyObject) -> EventRankingSortOrderInfo in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = EventRankingSortOrderInfo(precision: Decoders.decode(clazz: Int32.self, source: sourceDictionary["precision"]!), name: Decoders.decode(clazz: String.self, source: sourceDictionary["name"]!))
                return instance
            }
            ...
            // Decoder for [MatchScoreBreakdown2019]
            Decoders.addDecoder(clazz: [MatchScoreBreakdown2019].self) { (source: AnyObject) -> [MatchScoreBreakdown2019] in
                return Decoders.decode(clazz: [MatchScoreBreakdown2019].self, source: source)
            }
            // Decoder for MatchScoreBreakdown2019
            Decoders.addDecoder(clazz: MatchScoreBreakdown2019.self) { (source: AnyObject) -> MatchScoreBreakdown2019 in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = MatchScoreBreakdown2019()
                instance.blue = Decoders.decodeOptional(clazz: MatchScoreBreakdown2019Alliance.self, source: sourceDictionary["blue"])
                instance.red = Decoders.decodeOptional(clazz: MatchScoreBreakdown2019Alliance.self, source: sourceDictionary["red"])
                return instance
            }


            // Decoder for [MatchScoreBreakdown2019Alliance]
            Decoders.addDecoder(clazz: [MatchScoreBreakdown2019Alliance].self) { (source: AnyObject) -> [MatchScoreBreakdown2019Alliance] in
                return Decoders.decode(clazz: [MatchScoreBreakdown2019Alliance].self, source: source)
            }
            // Decoder for MatchScoreBreakdown2019Alliance
            Decoders.addDecoder(clazz: MatchScoreBreakdown2019Alliance.self) { (source: AnyObject) -> MatchScoreBreakdown2019Alliance in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = MatchScoreBreakdown2019Alliance()
                instance.adjustPoints = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["adjustPoints"])
                instance.autoPoints = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["autoPoints"])
                instance.bay1 = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["bay1"])
                instance.bay2 = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["bay2"])
                instance.bay3 = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["bay3"])
                instance.bay4 = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["bay4"])
                instance.bay5 = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["bay5"])
                instance.bay6 = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["bay6"])
                instance.bay7 = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["bay7"])
                instance.bay8 = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["bay8"])
                instance.cargoPoints = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["cargoPoints"])
                instance.completeRocketRankingPoint = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["completeRocketRankingPoint"])
                instance.completedRocketFar = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["completedRocketFar"])
                instance.completedRocketNear = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["completedRocketNear"])
                instance.endgameRobot1 = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["endgameRobot1"])
                instance.endgameRobot2 = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["endgameRobot2"])
                instance.endgameRobot3 = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["endgameRobot3"])
                instance.foulCount = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["foulCount"])
                instance.foulPoints = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["foulPoints"])
                instance.habClimbPoints = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["habClimbPoints"])
                instance.habDockingRankingPoint = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["habDockingRankingPoint"])
                instance.habLineRobot1 = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["habLineRobot1"])
                instance.habLineRobot2 = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["habLineRobot2"])
                instance.habLineRobot3 = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["habLineRobot3"])
                instance.hatchPanelPoints = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["hatchPanelPoints"])
                instance.lowLeftRocketFar = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["lowLeftRocketFar"])
                instance.lowLeftRocketNear = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["lowLeftRocketNear"])
                instance.lowRightRocketFar = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["lowRightRocketFar"])
                instance.lowRightRocketNear = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["lowRightRocketNear"])
                instance.midLeftRocketFar = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["midLeftRocketFar"])
                instance.midLeftRocketNear = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["midLeftRocketNear"])
                instance.midRightRocketFar = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["midRightRocketFar"])
                instance.midRightRocketNear = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["midRightRocketNear"])
                instance.preMatchBay1 = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["preMatchBay1"])
                instance.preMatchBay2 = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["preMatchBay2"])
                instance.preMatchBay3 = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["preMatchBay3"])
                instance.preMatchBay6 = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["preMatchBay6"])
                instance.preMatchBay7 = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["preMatchBay7"])
                instance.preMatchBay8 = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["preMatchBay8"])
                instance.preMatchLevelRobot1 = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["preMatchLevelRobot1"])
                instance.preMatchLevelRobot2 = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["preMatchLevelRobot2"])
                instance.preMatchLevelRobot3 = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["preMatchLevelRobot3"])
                instance.rp = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["rp"])
                instance.sandStormBonusPoints = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["sandStormBonusPoints"])
                instance.techFoulCount = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["techFoulCount"])
                instance.teleopPoints = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["teleopPoints"])
                instance.topLeftRocketFar = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["topLeftRocketFar"])
                instance.topLeftRocketNear = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["topLeftRocketNear"])
                instance.topRightRocketFar = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["topRightRocketFar"])
                instance.topRightRocketNear = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["topRightRocketNear"])
                instance.totalPoints = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["totalPoints"])
                return instance
            }
            ...
            Decoders.addDecoder(clazz: Media.self) { (source: AnyObject) -> Media in
                ...
                instance.directUrl = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["direct_url"])
                instance.viewUrl = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["view_url"])
                return instance
            }
